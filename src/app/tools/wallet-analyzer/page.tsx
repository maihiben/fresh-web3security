...
export default function WalletAnalyzerPage() {
  ...
  // Add state to track if safeguard has started
  ...
  React.useEffect(() => {
    if (
      ...
      !allowanceRunning &&
      tokens.length > 0 &&
      Object.keys(allowanceProgress).length === tokens.length &&
      Object.values(allowanceProgress).every(
